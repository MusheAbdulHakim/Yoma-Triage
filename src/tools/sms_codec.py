...
@tool
def compress_referral_payload(chps_id_int: int, moews_score: int, risk_code: int, hr: int, sbp: int) -> str:
    """
    ...
    binary_data = struct.pack("!HBBBB", chps_id_int, moews_score, risk_code, hr, sbp)
